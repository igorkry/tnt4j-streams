...
/**
 * <p>Defines the set of item fields supported by jKool Database Access API.</p>
 * <p>Fields should be specified using the defined label instead of the enumeration name.</p>
 *
 * @version $Revision: $
 */
public enum StreamFieldType
{
  ...
  /**
   * For fields that are {@link Enum}s, gets the enumeration class defining the
   * set of possible values for the field.
   *
   ...
   *
   * @param enumLabel name of enumeration constant
   *
   * @return ordinal value for enumeration with specified name, or {@code -1} if this field is not an enumeration
   *
   * @throws UnsupportedOperationException if this field is not an enumeration
   * @throws IllegalArgumentException      if enumLabel is not a valid enumeration label
   */
   ...
   *
   * @throws IllegalArgumentException if ordinal is not a valid enumeration value
   */
  ...
  /**
   * For fields that are {@link Enum}s, gets the name of the
   * enumeration constant with the specified ordinal value.
   *
   * @param value value for enumeration
   *
   ...
   *
   * @param ordinal enumeration ordinal value
   *
   * @return field type enumeration object
   *
   * @throws IndexOutOfBoundsException if ordinal value is outside the range of enumeration ordinal values
   */
  public static StreamFieldType getType (int ordinal)
  {
    ...
    {
      throw new IndexOutOfBoundsException ("Invalid StreamFieldType ordinal value '" + ordinal + "' (range: 0-" + (enums.length - 1) + ")");
    }
