 ...
 * how to locate a particular raw activity data item field for its corresponding
 * activity item value, as well as any transformations that are necessary.
 *
 * @version $Revision: 7 $
 */
public class ActivityFieldLocator
{
   ...
   *
   * @param type    type of locator - can be one of predefined values from {@link ActivityFieldLocatorType}
   *                or a custom type
   * @param locator key to use to locate raw data value
   *                - interpretation of this value depends on locator type
   *
   * @throws IllegalArgumentException if locator type is a numeric value and is not a positive number
   */
  ...
  /**
   * Constructs a new activity field locator that simply uses the specified value
   * as the value for this locator.
   *
   * @param value constant value for locator
   */
  ...
  /**
   * <p>Gets the type of this locator that indicates how to interpret the locator
   * to find the value in the raw activity data. This value can be one of the
   * predefined types, or it can be a custom type.</p>
   * <p>Note: Some activity fields will ignore this and assume that the field
   * locator is always a specific type.</p>
   *
  ...
  /**
   * <p>Gets the enumeration value for this locator if it implements one of the
   * built-in locator types.</p>
   * <p>Note: Some activity fields will ignore this and assume that the field
   * locator is always a specific type.</p>
   *
  ...
  /**
   * <p>Gets the locator to find the value of this field in the raw activity
   * data.  This is generally a numeric position or a string label.</p>
   *
  ...
  /**
   * <p>Get the radix that raw data field values are interpreted in.  Only relevant
   * for numeric fields and will be ignored by those fields to which it does not apply.</p>
   *
  ...
  /**
   * <p>Set the radix used to interpret the raw data field values.  Only relevant
   * for numeric fields and will be ignored by those fields to which it does not apply.</p>
   *
   * @param radix radix of field values
   */
  ...
  /**
   * <p>Gets the data type indicating how to treat the raw data field value.</p>
   * <p>Note: Some activity fields will ignore this and assume that the field value
   * is always a specific data type.</p>
   *
  ...
  /**
   * <p>Sets the data type indicating how to treat the raw data field value.</p>
   * <p>Note: Some activity fields will ignore this and assume that the field value
   * is always a specific data type.</p>
   *
   * @param dataType the data type for raw data field
   */
  ...
  /**
   * <p>Gets the units represented by the raw data field value.  This value can be one
   * of the predefined units, or it can be a custom unit type.</p>
   * <p>Note: This is not applicable for all fields and will be ignored by those fields.</p>
   *
  ...
  /**
   * <p>Gets the enumeration value for this locator's units if it implements one of
   * the built-in units types.</p>
  ...
  /**
   * <p>Sets the units represented by the raw data field value.  This value can be one
   * of the predefined units, or it can be a custom unit type.</p>
   * <p>Note: This is not applicable for all fields and will be ignored by those fields
   * to which it does not apply.</p>
   *
   * @param units the units the raw data value represents
   */
  ...
  /**
   * <p>Gets locale representation string used by formatter.</p>
   * <p>Note: This is not applicable for all fields and will be ignored by those fields
   * to which it does not apply.</p>
   *
  ...
  /**
   * <p>Gets the enumeration value for this locator's format if it implements one of
   * the built-in format types.</p>
   * <p>Note: This is not applicable for all fields and will be ignored by those fields
   * to which it does not apply.</p>
   *
   ...
   * @param locale locale for formatter to use.
   */
   ...
   *
   * @param requiredVal true/false string
   */
   ...
   *
   * @param source raw data value
   * @param target value to translate raw value to
   */
   ...
   *
   * @throws ParseException if error applying locator format properties to specified value
   */
  ...
  /**
   * Formats the value for the specified numeric field based on the
