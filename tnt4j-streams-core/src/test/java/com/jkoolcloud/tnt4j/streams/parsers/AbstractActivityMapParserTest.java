...
public class AbstractActivityMapParserTest {
	...
	public void parseTest() throws Exception {
		...
		testParser.parse(mock(CamelBufferedStream.class), myMap);
	}
	...
	public void parseWhenDataIsEmptyTest() throws Exception {
		ActivityMapParser testParser = new ActivityMapParser();
		Map<String, String> myMap = new HashMap<String, String>();
		assertNull(testParser.parse(mock(CamelBufferedStream.class), myMap));
	}
	...
	public void getLocatorValueTest() throws Exception {
		...
		myMap.put("test", "OK");
		myMap.put("555", "hello");
		assertEquals("hello", testParser.getLocatorValue(mock(CamelBufferedStream.class), fieldLocator, myMap));
	}
	...
	public void getLocatorValueWhenFieldLocatorNullTest() throws Exception {
		...
		myMap.put("test", "OK");
		myMap.put("status", "finished");
		assertNull(testParser.getLocatorValue(mock(CamelBufferedStream.class), null, myMap));
	}
	...
	public void getLocatorValueWhenLocatorEmptyTest() throws Exception {
		...
		myMap.put("test", "OK");
		myMap.put("status", "finished");
		assertNull(testParser.getLocatorValue(mock(CamelBufferedStream.class), fieldLocator, myMap));
	}
	...
	public void getLocatorValueWhenDataIsNullTest() throws Exception {
		...
		assertNull(testParser.getLocatorValue(mock(CamelBufferedStream.class), fieldLocator, null));
	}
	...
	public void getLocatorValueNumberExceptionTest() throws Exception {
		...
		myMap.put("status", "TEST");
		List<String> output = (List<String>) testParser.getLocatorValue(mock(CamelBufferedStream.class), fieldLocator,
				myMap);
	...
	public void getLocatorValueInstanceTest() throws Exception {
		...
		Map<String, Object> myMap = new HashMap<String, Object>();
		myMap.put("333", "TEST1");
		assertEquals("TEST1", testParser.getLocatorValue(mock(CamelBufferedStream.class), fieldLocator, myMap));
	}
